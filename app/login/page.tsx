...
import { ArrowRight, Mail, Lock, Eye, EyeOff, Github, Chrome, ArrowLeft, Home } from "lucide-react"
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-md">
              Sign in to manage your tournaments and track your competitions with ease.
            </p>
          </div>
          <div className="space-y-4 pt-8">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Organize brackets and schedules effortlessly
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Get insights into your tournament performance
                </p>
              </div>
            </div>
          </div>
